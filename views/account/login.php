<?php		
$login_nonce = wp_create_nonce('mo-site-login-nonce');
$cancel_nonce =wp_create_nonce('mo-site-cancel-nonce');

echo'	<form name="f" method="post" action="">
			<input type="hidden" name="option" value="mosa_verify_customer" />
			<input type="hidden" name="mo_site_login_nonce" value="'.esc_html($login_nonce).'" />
			<div class="mo_wpns_divided_layout">
				<div class="mo_wpns_setting_layout">
					...
					<table class="mo_wpns_settings_table">
						...
						<tr>
							<td>&nbsp;</td>
							<td><input type="submit" class="mo_wpns_button mo_wpns_button1" value="Submit" />
		...
		<form id="cancel_form" method="post" action="">
			<input type="hidden" name="option" value="mosa_cancel" />
			<input type="hidden" name="mo_site_cancel_nonce" value="'.esc_html($cancel_nonce).'" />
		</form>
		<script>
