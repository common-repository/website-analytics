...
$nonce = wp_create_nonce('mo-site-register-nonce');
echo'<!--Register with miniOrange-->
	<form name="f" method="post" action="">
		<input type="hidden" name="option" value="mosa_register_customer" />
		<input type="hidden" name="mo_site_register_nonce" value="'.esc_html($nonce).'" />
	 ...
	 <form name="f" method="post" action="" class="mo2f_verify_customerform">
        <input type="hidden" name="option" value="mosa_goto_verifycustomer">
